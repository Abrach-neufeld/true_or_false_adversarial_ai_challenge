    ...
    <div className="relative w-full bg-white shadow-sm py-6 px-6 border-b border-gray-100">
      <div className="flex items-center justify-center gap-3">
        ...
        <div className="relative">
          ...
          />
          {showInfo && (
            <div className="absolute right-0 mt-2 w-[512px] p-4 bg-white rounded-lg shadow-lg border border-gray-100 z-50 transform transition-all duration-200 ease-in-out">
